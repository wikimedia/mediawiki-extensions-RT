...
$messages['ja'] = array(
	...
	'rt-badlimit' => "LIMIT (l) の引数が無効：数値でなくてはなりません。
与えられた値: '''$1'''",
	'rt-badorderby' => "ORDER BY (ob) の引数が無効：標準のフィールドでなくてはなりません(ドキュメントを参照)。
与えられた値: '''$1'''",
	'rt-badstatus' => "status (s) の引数が無効：標準のフィールドでなくてはなりません(ドキュメントを参照)。
与えられた値: '''$1'''",
